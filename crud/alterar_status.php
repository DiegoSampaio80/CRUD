...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div  class="table">
            <form action="./alterar_status_processar.php" method="GET">
                <h2>Alterar Status</h2>
                <label for="nome_status">
                    <p>Modelo: <input type="text" name="nome_status" value="<?php echo $lista['nome_status'] ;?>"></p>
                </label>
                <input type="hidden" name="id_status" value="<?php echo $lista['id_status'] ;?>">
