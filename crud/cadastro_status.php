...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div class="table">
                <form action="./cadastro_status_processar.php" method="get" id="formCadastroCliente">
                    <h2>
                        Cadastro Status
                    </h2>
                    <label for="nome_status" class="inputCadastroCliente">
                        <p>Nome status: <input type="text" class="inputCadastroCliente" name="nome_status" id="nome_status"></p> 
                    </label>
