                ...
                <table border="1">
                    ...
                    <?php
                        ...
                        $consulta_cliente = $conexao->query("SELECT * FROM cliente LEFT JOIN endereco 
                            ON endereco_id_endereco = id_endereco WHERE nome_completo LIKE '%$nome_completo%'");
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="alterar_cliente.php?alterar=<?php echo $lista['nome_completo']; ?>">Alterar</a></td>
                            <td><a href="excluir_cliente.php?excluir=<?php echo $lista['nome_completo']; ?>">Excluir</a></td>
                        </tr>
                    <?php 
                        }
                    ?>
