    ...
    <main>
        ...
        <section>
            ...
            <div id="areaCadastroCliente">
                ...
                $cadastro_eletronico = $conexao->prepare("INSERT INTO `eletronico` (`modelo`, `marca`,
                `numero`, `descricao`)
                VALUES(:modelo, :marca, :numero, :descricao);");

                $cadastro_eletronico->execute(array(
                    ':modelo' => $modelo,
                    ':marca' => $marca,
                    ':numero' => $numero,
                    ':descricao' => $descricao
                ...
                if ($cadastro_eletronico->rowCount() > 0) {
                   ...
                   /*  echo 'Eletrônico cadastrado com Sucesso!'; */
                    ...
                    $id_eletronico = $conexao->lastInsertId();
