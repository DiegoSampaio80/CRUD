...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div  class="table">
            <form action="./consultar_eletronico_processar.php" method="post"  >
            <h2>Consultar Eletrônico</h2>
                <label for="modelo">
                    <p>Modelo: <input type="text" name="modelo" class="inputCadastroCliente" id="modelo"></p>
                </label>
                <label for="marca">
                    <p>Marca: <input type="text" name="marca" class="inputCadastroCliente" id="marca"></p>
                </label>
                <label for="numero">
                    <p>Número: <input type="number" name="numero" class="inputCadastroCliente" id="numero"></p>
                </label>
                <label for="descricao">
                    <p>Descrição: <input type="text" name="descricao" class="inputCadastroCliente" id="descricao"></p>
                </label>
                <!-- <input type="hidden" name="id_eletronico"> -->
