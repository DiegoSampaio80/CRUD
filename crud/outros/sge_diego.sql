...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Nov-2021 às 15:29
...
(1, '71727-227', 'Candangolândia', 'DF', 'N/A', 'QRO A', 'Conjunto H casa 10');
...
ALTER TABLE `reparo`
  ...
  ADD CONSTRAINT `fk_reparo_status1` FOREIGN KEY (`status_id_status`) REFERENCES `status` (`id_status`) ON DELETE NO ACTION ON UPDATE NO ACTION,
