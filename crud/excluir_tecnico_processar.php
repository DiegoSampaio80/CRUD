        ...
        <section class="sectionTable">
            ...
            <div class="table">
                ...
                <?php
                    ...
                    $excluir_tecnico = $conexao->prepare("DELETE FROM `tecnico` 
                    WHERE id_tecnico = :id_tecnico");

                    $excluir_tecnico->execute(array(
                ...
                <table border="1">
                    ...
                    $consultar_tecnico = $conexao->query("SELECT * FROM `tecnico`
                    /* WHERE id_tecnico = $id_tecnico */");

                    while($lista = $consultar_tecnico->fetch(PDO::FETCH_ASSOC)){
                    ?>
                    <tr>
