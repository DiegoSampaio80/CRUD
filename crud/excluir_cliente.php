...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div  class="table">
            <form action="./excluir_cliente_processar.php" method="GET"  >
            <h2>Excluir Cadastro Cliente</h2>
                <label for="nome_completo">
                    <p>Nome: <input type="text" name="nome_completo" value="<?php echo $lista['nome_completo'] ;?>"></p>
                </label>
