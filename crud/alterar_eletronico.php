...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div  class="table">
            <form action="./alterar_eletronico_processar.php" method="GET"  >
                <h2>Alterar Cadastro Eletrônico</h2>
                <label for="modelo">
                ...
                <label for="descricao">
                    <p>Descrição: <textarea name="descricao" id="descricao" cols="100" rows="7"><?php echo $lista['descricao'] ;?></textarea>
                </label> 
