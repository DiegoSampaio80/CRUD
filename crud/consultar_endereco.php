...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div  class="table">
                <form action="./consultar_endereco_processar.php" method="post">

                    <h2>Consultar Endereço</h2>

                    <label for="rua" class="inputCadastroCliente">Rua: </label>
                    <input type="text" class="inputCadastroCliente" name="rua" id="rua"><br>

                    <label for="cep" class="inputCadastroCliente">CEP: </label>
                    <input type="text" class="inputCadastroCliente" name="cep" id="cep"><br>
