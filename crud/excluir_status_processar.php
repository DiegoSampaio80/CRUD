        ...
        <section class="sectionTable">
            ...
            <div class="table">
                ...
                <?php
                    ...
                    $excluir_status = $conexao->prepare("DELETE FROM `status` 
                    WHERE id_status = :id_status");

                    $excluir_status->execute(array(
                ...
                <table border="1">
                    ...
                    $consultar_status = $conexao->query("SELECT * FROM `status`
                    /* WHERE id_status = $id_status */");

                    while($lista = $consultar_status->fetch(PDO::FETCH_ASSOC)){
                    ?>
                    <tr>
