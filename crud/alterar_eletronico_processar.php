    ...
    <main>
        ...
        <section class="sectionTable">
            ...
            <div class="table">
                ...
                $id_eletronico = $_GET['id_eletronico'];

                /* echo "id_eletronico: ".$id_eletronico."<br>";
                echo "modelo: ".$modelo."<br>"; */
    


                $alterar_eletronico = $conexao->prepare("UPDATE `eletronico` 
                SET `modelo` = :modelo,
                    `marca` = :marca,
                    `numero` = :numero,
                    `descricao` = :descricao 
                WHERE `eletronico`.`id_eletronico` = :id_eletronico");

                $alterar_eletronico->execute(array(
                    ':modelo' => $_GET['modelo'],
                    ':marca' => $_GET['marca'],
                    ':numero' => $_GET['numero'],
                    ':descricao' => $_GET['descricao'],
